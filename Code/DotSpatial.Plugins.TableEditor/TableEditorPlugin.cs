...
namespace DotSpatial.Plugins.TableEditor
{
    public class TableEditorPlugin : Extension
    {
        ...
        const string contextMenuItemName = "属性表编辑";

        public override void Activate()
        {
            App.HeaderControl.Add(new SimpleActionItem(HeaderControl.HomeRootItemKey, "查看属性表", AttributeTable_Click) { GroupCaption = "Map Tool", SmallImage = Resources.table_16x16, LargeImage = Resources.table_32x32 });
